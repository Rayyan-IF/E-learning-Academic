        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                <div class="profile-info">
                    ...
                    <div class="user-info">
                        <?php $guest = $this->db->get_where('guest', ['id_guest' => $this->session->userdata('id')])->row(); ?>
                        <img src="<?= base_url('assets/app-assets/user/') . $guest->avatar; ?>" alt="avatar" class="bg-white">
                        <h6 class=""><?= $guest->nama_guest; ?></h6>
                        <p class="">guest E-Learning</p>
                    </div>
                </div>
                <div class="shadow-bottom"></div>
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu <?= $dashboard['menu']; ?>">
                        <a href="<?= base_url('guest'); ?>" aria-expanded="<?= $dashboard['expanded']; ?>" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu <?= $menu_profile['menu']; ?>">
                        <a href="<?= base_url('guest/profile'); ?>" aria-expanded="<?= $menu_profile['expanded']; ?>" class="dropdown-toggle">
                            <div class="">
                                <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
