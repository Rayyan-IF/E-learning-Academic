                    ...
                    <li class="menu <?= $menu_ujian['menu']; ?>">
                        <a href="<?= base_url('siswa/ujian'); ?>" aria-expanded="<?= $menu_ujian['expanded']; ?>" class="dropdown-toggle">
                            <div class="">
                                ...
                                <span>Ujian / Quiz</span>
                            </div>
                        </a>
                    </li>
					<li class="menu <?= $menu_absensi['menu']; ?>">
						<a href="<?= base_url('siswa/absensi_depan'); ?>" aria-expanded="<?= $menu_absensi['expanded']; ?>" class="dropdown-toggle">
							<div class="">
								<svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
									<path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path>
									<path d="M13.73 21a2 2 0 0 1-3.46 0"></path>
