                        ...
                        <div class="col">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-table" class="table table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                        <?php $no = 1;
                                        $kelass = $this->db->get('kelas')->result();
                                        foreach ($detailmapel as $dm) :
                                        ?>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $dm->nama_mapel; ?></td>
                                                <td>
                                                    <?php foreach ($kelass as $kel) : ?>
                                                        <?php if ($kel->id_kelas == $dm->kelas) {
                                                            echo $kel->nama_kelas;
                                                        } ?>
                                                    <?php endforeach; ?>
                                                </td>
                                                <td><?= $dm->tahun_ajaran; ?></td>
                                                <td>
                                                    <a href="javascript:void(0);" data-mapel="<?= encrypt_url($dm->id_mapel); ?>" data-toggle="modal" data-target="#edit_mapel" class="btn btn-primary edit-mapel">Edit
                                                    ...
                                                    <a class="btn btn-danger btn-hapus" href="<?= base_url('app/hapus_mapel/') . encrypt_url($dm->id_mapel); ?>">Delete
                                                        <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1">
                ...
                <div class="modal-body">
                    ...
                    <table id class="table table-bordered">
                        ...
                        <tbody id="tbody-mapel">
                            <tr>
                                <td><input type="text" name="nama_mapel[]" required style="border: none; background: transparent;"></td>
                                <td>
                                    <?php
                                ...
                                <td><input type="text" name="tahun_ajaran[]" required style="border: none; background: transparent; "></td>
                                <td></td>
                            </tr>
                        </tbody>
                    </table>
