					...
					<div class="row">
						<div class="col">
							<div class="widget-heading">
								...
								<a href="<?= base_url('guru/absensi') ?>" class="btn btn-primary mt-3">Tambah Kehadiran</a>
							</div>
							<div class="table-responsive">
								<table id="datatable-table" class="table table-bordered table-striped text-center">
									...
									<tbody>
										<?php
										$detail_guru_absen = $this->db->select("*")->from("absensi")->where('id_guru', $this->session->userdata('id'))
											->group_by("jam")
											->get()
											->result();
										...
										<?php foreach ($detail_guru_absensi as $ab) : ?>
											<tr>
												...
												<td>
													<a href="<?= base_url('guru/absensi_detail/')  .  encrypt_url($ab->pertemuan . ',' . $ab->id_kelas); ?>" class="btn btn-warning btn-sm btn-flat fa fa-check-square">Detail</a>
												</td>
											</tr>
										<?php endforeach; ?>
									</tbody>
