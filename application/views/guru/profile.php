                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="widget-heading text-center">
                                ...
                                <p style="margin-top: -3px;">GURU E-Learning</p>
                                ...
                                <div class="d-flex justify-content-center">
                                    <table cellpadding="2" class="mt-3 text-center">
                                        ...
                                        <tr>
                                            <td>
                                                <a href="javasript:void(0)" class="btn btn-primary profile-guru" data-guru="<?= encrypt_url($guru->id_guru); ?>" data-toggle="modal" data-target="#edit_profile">Update Profile</a>
                                            </td>
                                            <td>
                                                <a href="javasript:void(0)" class="btn btn-primary password-guru" data-guru="<?= encrypt_url($guru->id_guru); ?>" data-toggle="modal" data-target="#edit_password">Update Password</a>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
